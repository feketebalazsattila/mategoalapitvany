...
if ($valid==true)
{
	...
	$sql = "UPDATE foglalkozas SET nev='" . $nev . "' WHERE id = " . $_SESSION["id"];
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h1>Név mmódosítása</h1>
                    </div>
							
							<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
								<h3>Új név: </h3> <input class="form-control" type="text" name="nev" value="<?php echo $_SESSION['nev']?>"/>  <span class="error">* <?php echo $nevErr;?></span> 
