...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$valid=true;
	if (empty($_POST["vnev"])) {
				$vnevErr = "Lakhely megadása kötelező!";
				$valid=false;
				} else {
...
if ($valid==true)
{
	...
	$sql = "UPDATE diak SET lakhely='" . $vnev . "' WHERE id = " . $_SESSION["id"];
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h1>Lakhely mmódosítása</h1>
                    </div>
							
							<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
								<h3>Lakhely: </h3> <input class="form-control" type="text" name="vnev" value="<?php echo $_SESSION['nev']?>"/>  <span class="error">* <?php echo $vnevErr;?></span> 
