...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$valid=true;
	if (empty($_POST["vnev"])) {
				$vnevErr = "Email megadása kötelező!";
				$valid=false;
				} else {
					
					$vnev=test_input($_POST["vnev"]);
					if(!filter_var($vnev, FILTER_VALIDATE_EMAIL)){
...
if ($valid==true)
{
	...
	$sql = "UPDATE diak SET email2='" . $vnev . "' WHERE id = " . $_SESSION["id"];
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h1>E-mail mmódosítása</h1>
                    </div>
							
							<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
								<h3>Új e-mail: </h3> <input class="form-control" type="text" name="vnev" value="<?php echo $_SESSION['nev']?>"/>  <span class="error">* <?php echo $vnevErr;?></span> 
