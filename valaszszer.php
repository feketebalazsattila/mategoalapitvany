                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
										...
										echo "<td>";
                                            echo "<a href='valaszmod.php?id=". $row['id'] ."' title='Válasz modosítása' data-toggle='tooltip'> Válasz modosítása</a><br>";
                                            echo "<a href='megjelen.php?id=". $row['id'] ."' title='Megjelent állapot modosítása' data-toggle='tooltip'>Megjelent állapot modosítása</a>";
                                        echo "</td>";
