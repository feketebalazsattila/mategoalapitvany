...
if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
		$url = "http://localhost/h%C3%A1zi/infogener.php?id=" . $_GET['id'];
    // Include config file
    include "db.php";
	$link=opendb();
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h1>Melyik évfolyamoknak kíván információt küldeni?</h1>
                    </div>
					...
					<form method="post" action="<?php echo $url;?>">
							...
							<br></br>
							<input type="submit" class="btn btn-primary" value="Elküld" name="uj" />  <a  class="btn btn-default" href="foglalkozasgener.php">Vissza</a>
						</form>
                </div>
            </div>        
        </div>
